...
чата. Раньше пул собирался в двух местах порознь одним и тем же кодом (_pool в командах
и участок в answer_chat) - и при первой же правке сборки копии грозили разъехаться,
